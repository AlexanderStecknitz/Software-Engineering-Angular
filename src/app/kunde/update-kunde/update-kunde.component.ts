...
import type { Adresse, Umsatz } from '../shared/kunde';
...
export class UpdateKundeComponent implements OnInit {
    ...
    onSubmit() {
        ...
        const { postleitzahl } = this.updateForm.value as {
            postleitzahl: Adresse;
        };
        const { umsatz } = this.updateForm.value as {
        ...
        kunde.postleitzahl = postleitzahl;
        kunde.umsatz = umsatz;
